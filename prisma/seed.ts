...
async function main() {
  ...
  const operators = await Promise.all([
    prisma.operator.upsert({
      ...
      create: { name: "Adventure Turtle Bus", slug: "turtle-bus", description: "Tours temáticos únicos en Medellín a bordo de nuestro icónico bus.", commercialName: "Adventure Turtle Bus Medellín", contactEmail: "info@turtlebus.co", status: "active", logoUrl: "/logos/logo-turtlebus.webp" },
    }),
    prisma.operator.upsert({
  ...
  const wholesalePackagesData = [
    {
      ...
      operatorBreakdown: [{ name: "Adventure Turtle Bus", experience: "Tour Ciudad Innovación + Chiva Nocturna Premium" }, { name: "Metro Cultura", experience: "Tour grafiti y arte urbano, visita El Poblado" }],
    ...
    },
    {
      ...
      operatorBreakdown: [{ name: "Guatapé Travel", experience: "Guía local, lancha, zócalos y logística en Guatapé" }, { name: "Adventure Turtle Bus", experience: "Transporte privado Medellín – Guatapé – Medellín" }],
    ...
    },
    {
      ...
      operatorBreakdown: [{ name: "Adventure Turtle Bus", experience: "Transporte privado todo el recorrido" }, { name: "Metro Cultura", experience: "Tour grafiti, innovación y vida nocturna" }, { name: "Guatapé Travel", experience: "Guatapé, El Peñol y embalse" }, { name: "Colombia Coffee Routes", experience: "Aventura en Jardín y finca cafetera" }],
    ...
    },
    {
      ...
      operatorBreakdown: [{ name: "Aeroturex", experience: "Kayak, rapel y tirolesa en Guatapé" }, { name: "Adventure Turtle Bus", experience: "Transporte privado y logística" }, { name: "Metro Cultura", experience: "Tour innovación y Parque Explora" }, { name: "Guatapé Travel", experience: "Coordinación en Guatapé y el embalse" }],
