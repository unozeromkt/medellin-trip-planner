  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <Section title="Información básica">
        ...
        <Field label="Imagen destacada (URL)" error={errors.coverImage?.message} hint="URL de imagen 800×480px aprox. Usa el módulo de uploads.">
      ...
      <Section title="Destinos y operadores">
        <Field label="Destinos *" error={errors.destinations?.message} hint="Un destino por línea">
          <textarea {...register("destinations")} rows={3} placeholder={"Medellín\nGuatapé\nSanta Fe de Antioquia"} className={textareaClass} />
        </Field>
        <div className="grid sm:grid-cols-2 gap-4">
